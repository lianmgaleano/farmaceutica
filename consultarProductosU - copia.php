...
session_start();
if($nombre == ""){
	$sentencia = "SELECT P.idproducto id_producto, P.nombre nombre_producto, T.nombre tipo, M.nombre marca, P.precio precio FROM producto P LEFT JOIN tipo T ON T.idtipo = P.id_tipo LEFT JOIN marca M ON M.idmarca = P.id_marca WHERE P.idproducto = 1";
}else{
